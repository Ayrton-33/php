            ...
            <div class="col-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="my-3">
                        ...
                        <input type="number" name="txtDocumento" id="txtDocumento" class="form-control" required placeholder="Ingrese su Documento" value="<?php echo isset($aClientes[$pos])? $aClientes[$pos]["documento"]: ""; ?>">
                    </div>
                    <div class="my-3">
                        <label for="">Nombre:*</label>
                        <input type="text" name="txtNombre" id="txtNombre" class="form-control" required placeholder="Nombre y Apellido" value="<?php echo  isset($aClientes[$pos])? $aClientes[$pos]["nombre"]: ""; ?>">
                    </div>
                    <div class="my-3">
                        <label for="">Teléfono:</label>
                        <input type="tel" name="txtTelefono" id="txtTelefono" class="form-control" placeholder="Teléfono" value="<?php echo  isset($aClientes[$pos])? $aClientes[$pos]["telefono"]: ""; ?>">
                    </div>
                    <div class="my-3">
                        <label for="">Correo:*</label>
                        <input type="email" name="txtCorreo" id="txt" class="form-control" required placeholder="Correo" value="<?php echo  isset($aClientes[$pos])? $aClientes[$pos]["correo"]: ""; ?>">
                    </div>
                    <div class="my-3">
                        <label for="">Archivo adjunto:</label>
                        <input type="file" name="archivo" id="archivo" accept=".jpg, .jpeg, .png" class="form-control">
